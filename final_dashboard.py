...
with tab3:
    ...
    # 📈 STATE ESTIMATION DIAGNOSTICS (real model output, not synthetic data)
    st.divider()
    st.markdown("### 📈 Power Grid State Estimation Diagnostics")
    st.write("Real vs. predicted capacity (ρ) from the trained state-estimation LSTM, generated by `evaluate_models.py`.")
